...
from .views import predict_view, chatbot_api, evaluate_feasibility, evaluate_risk, predict_cost_overtime
...
urlpatterns = [
    ...
    path('predict_cost_overtime/', predict_cost_overtime, name='predict_cost_overtime'),
]